...
Config.Discord = {
    ...
    applicationId = '1172552763285192804',                 -- The discord application id
    iconLarge = 'caRIOca', -- The name of the large icon
    ...
    buttons = {
        {
            text = 'JOGAR',
            url = 'https://servers.fivem.net/servers/detail/36xrvb'
        },
        {
            text = 'DISCORD',
            url = 'https://discord.gg/sgmSDjmk'
        }
    }
}
...
Config.Teleports = {
    ...
    [2] = { --Coke Processing Enter/Exit
        ...
        [2] = {
            ...
            allowVeh = false,
            label = '[ALT] Entrar no processamento de cocaína'
        }
    },
    [3] = { --Coke Processing Enter/Exit
        [1] = {
            poly = {coords = vector3(1066.3046, -3183.5652, -39.1637), heading = 306.4559, length = 2, width = 2},
            allowVeh = false,
            label = '[ALT] Entrar no colheita de maconha'
        },
        [2] = {
            poly = {coords = vector3(-10.3534, -1828.2061, 25.3875), heading = 321.3952, length = 2, width = 2},
            allowVeh = false,
            label = '[ALT] Sair'
        }
    },
    [4] = { --Coke Processing Enter/Exit
        [1] = {
            poly = {coords = vector3(-139.45, -617.32, 167.82), heading = 281.3225, length = 2, width = 2},
            allowVeh = false,
            label = '[ALT] Entrar'
        },
        [2] = {
            poly = {coords = vector3(-118.4380, -607.6502, 36.2807), heading = 37.3583, length = 2, width = 2},
            allowVeh = false,
            label = '[ALT] Sair'
        }
    }
